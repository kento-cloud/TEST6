  ...
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-8">
      ...
      <div className="mt-8 text-sm text-[#a9abb8] leading-relaxed">
        ...
        <p>
          PADDOCKは、AIの力で競馬情報を見極める映像メディアです。レース分析、血統解説、調教師・騎手インタビューなど、競馬の深い世界を高品質な映像コンテンツとしてお届けしています。
        </p>
        <p className="mt-3">
          「データと映像で、競馬をもっと楽しく。」をミッションに掲げ、AI文字起こし・要約・記事生成で動画コンテンツを多角的に楽しめるプラットフォームを提供しています。
        </p>
      </div>
    </div>
  );
