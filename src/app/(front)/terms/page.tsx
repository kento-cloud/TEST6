    ...
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-8">
      ...
      <div className="text-sm text-[#a9abb8] leading-relaxed space-y-6">
        <section>
          ...
          <p>
            本規約は、株式会社PADDOCK（以下「当社」といいます）が提供するPADDOCKサービス（以下「本サービス」といいます）の利用に関する条件を、本サービスを利用するすべてのユーザー（以下「ユーザー」といいます）と当社との間で定めるものです。ユーザーは、本規約に同意の上、本サービスを利用するものとします。
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>「本サービス」とは、当社が運営する競馬情報メディア「PADDOCK」を指します。</li>
