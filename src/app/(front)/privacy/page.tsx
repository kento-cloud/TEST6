  ...
  return (
    <div className="max-w-3xl mx-auto px-6 md:px-10 py-8">
      ...
      <div className="text-sm text-[#a9abb8] leading-relaxed space-y-6">
        <p>
          株式会社AI MEDIA（以下「当社」といいます）は、当社が提供するサービス「AI MEDIA」（以下「本サービス」といいます）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。
        </p>
        ...
        <section>
          ...
          <p className="mt-2">
            株式会社AI MEDIA 個人情報保護担当
            <br />
            メール: privacy@aimedia.jp
          </p>
        </section>
